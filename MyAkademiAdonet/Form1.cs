...
namespace MyAkademiAdonet
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection("Server=SAADET\\SQLEXPRESS01; initial Catalog=DbMyPortfolio;integrated Security=true");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("@p2", richTextBox1.Text);
            command.Parameters.AddWithValue("@p3", cmbCategory.Text);
            command.Parameters.AddWithValue("@p4", txtValue.Text);
        ...
        {
            connection.Open();
            SqlCommand command = new SqlCommand("Delete From Project Where Project=@p1", connection);
